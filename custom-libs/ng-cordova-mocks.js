 ...
 */
 (function(){
 	var ngCordovaCustom = angular.module('ngCordovaCustom', []);
/**
 * @ngdoc service
 * @name ngCordovaCustom.cordovaBarcodeScanner
 *
 * @description
 * A service for testing barcode scanner features
 * in an app build with ngCordovaCustom.
 **/ 
 ngCordovaCustom.factory('$cordovaBarcodeScanner', ['$q', function($q) {
 	...
 	return {
		 ...
		 * @ngdoc property
		 * @name throwsError
		 * @propertyOf ngCordovaCustom.cordovaBarcodeScanner
		 *
		 * @description
...
/**
 * @ngdoc service
 * @name ngCordovaCustom.cordovaCamera
 *
 * @description
 * A service for testing camera features
 * in an app build with ngCordovaCustom.
 **/ 
 ngCordovaCustom.factory('$cordovaCamera', ['$q', function($q) {
 	var throwsError = false;
 	...
 	return {
		 ...
		 * @ngdoc property
		 * @name throwsError
		 * @propertyOf ngCordovaCustom.cordovaCamera
		 *
		 * @description
		 * A flag that signals whether a promise should be rejected or not. 
		 * This property should only be used in automated tests.
...
/**
 * @ngdoc service
 * @name ngCordovaCustom.cordovaCapture
 *
 * @description
 ...
 * @example
 */ 
 ngCordovaCustom.factory('$cordovaCapture', ['$q', function($q) {
 	var throwsError = false;
 	...
 	return {
		 ...
		 * @ngdoc property
		 * @name throwsError
		 * @propertyOf ngCordovaCustom.cordovaCapture
		 *
		 * @description
		 * A flag that signals whether a promise should be rejected or not. 
		 * This property should only be used in automated tests.
...
/**
 * @ngdoc service
 * @name ngCordovaCustom.cordovaContacts
 *
 * @description
 * A service for testing features related with contacts
 * in an app build with ngCordovaCustom.
 **/  
 ngCordovaCustom.factory('$cordovaContacts', ['$q', function($q) {
 	var throwsError = false;
 	var contacts = [];
 	...
 	return {
		 ...
		 * @ngdoc property
		 * @name throwsError
		 * @propertyOf ngCordovaCustom.cordovaContacts
		 *
		 * @description
		 * A flag that signals whether a promise should be rejected or not.
		 * This property should only be used in automated tests.
...
/**
 * @ngdoc service
 * @name ngCordovaCustom.cordovaDatePicker
 *
 * @description
 * A service for testing datepicker features
 * in an app build with ngCordovaCustom.
 */
 ngCordovaCustom.factory('$cordovaDatePicker', function () {
 	return {
...
/**
 * @ngdoc service
 * @name ngCordovaCustom.cordovaDevice
 *
 * @description
 * A service for testing device information
 * in an app build with ngCordovaCustom.
 **/  
 ngCordovaCustom.factory('$cordovaDevice', function () {
 	var device = '';
 	var cordova = '';
 	var model = '';
 	var platform = '';
 	...
 	return {
		 ...
		 * @ngdoc property
		 * @name device
		 * @propertyOf ngCordovaCustom.cordovaDevice
		 *
		 * @description
...
/**
 * @ngdoc service
 * @name ngCordovaCustom.cordovaDeviceMotion
 *
 * @description
 * A service for mocking the accelerometer
 * in an app build with ngCordovaCustom.
 **/  
 ngCordovaCustom.factory('$cordovaDeviceMotion', ['$interval', '$q', function ($interval, $q) {
 	...
 	return {
		 ...
		 * @propertyOf ngCordovaCustom.cordovaDeviceMotion
		 *
		 * @description
 ...
 /**
 * @ngdoc service
 * @name ngCordovaCustom.cordovaDeviceOrientation
 *
 * @description
 * A service for testing compass fetures
 * in an app build with ngCordovaCustom.
 */
 ngCordovaCustom.factory('$cordovaDeviceOrientation', ['$interval', '$q', function ($interval, $q) {
 	...
 	return {
		 ...
		 * @ngdoc property
		 * @name currentHeading
		 * @propertyOf ngCordovaCustom.cordovaDeviceOrientation
		 *
		 * @description
		 * The current heading.
		 * This property should only be used in automated tests.
...
/**
 * @ngdoc service
 * @name ngCordovaCustom.cordovaDialogs
 *
 * @description
 * A service for testing dialogs
 * in an app build with ngCordovaCustom.
 */ 
 ngCordovaCustom.factory('$cordovaDialogs', ['$q', function ($q) {
 	...
 	return {
		 ...
		 * @ngdoc property
		 * @name dialogText
		 * @propertyOf ngCordovaCustom.cordovaDialogs
		 *
		 * @description
...
/**
 * @ngdoc service
 * @name ngCordovaCustom.cordovaFile
 *
 * @description
 * A service for testing interaction with device directories and files
 * in an app build with ngCordovaCustom.
 */
 ngCordovaCustom.factory('$cordovaFile', ['$q', function($q) {
 	var throwsError = false;
 	var fileSystem = {};
    ...
    /**
		 * @ngdoc property
		 * @name throwsError
		 * @propertyOf ngCordovaCustom.cordovaFile
		 *
		 * @description
		 * A flag that signals whether a promise should be rejected or not.
		 * This property should only be used in automated tests.
...
/**
 * @ngdoc service
 * @name ngCordovaCustom.cordovaGeolocation
 *
 * @description
 * A service for testing location services
 * in an app build with ngCordovaCustom.
 */
 ngCordovaCustom.factory('$cordovaGeolocation', ['$interval', '$q', function($interval, $q) {
 	var throwsError = false;
 	var useHostAbilities = true;
 	...
 	return {
		 ...
		 * @ngdoc property
		 * @name throwsError
		 * @propertyOf ngCordovaCustom.cordovaGeolocation
		 *
		 * @description
		 * A flag that signals whether a promise should be rejected or not.
		 * This property should only be used in automated tests.
...
/**
 * @ngdoc service
 * @name ngCordovaCustom.cordovaGlobalization
 *
 * @description
 * A service for testing features related to a user's locale and timezone.
 * in an app build with ngCordovaCustom.
 */ 
 ngCordovaCustom.factory('$cordovaGlobalization', ['$q', function($q) {
 	var throwsError = false;
 	...
 	return {
		 ...
		 * @ngdoc property
		 * @name throwsError
		 * @propertyOf ngCordovaCustom.cordovaGlobalization
		 *
		 * @description
		 * A flag that signals whether a promise should be rejected or not. 
		 * This property should only be used in automated tests.
...
/**
 * @ngdoc service
 * @name ngCordovaCustom.cordovaKeyboard
 *
 * @description
 * A service for testing device keyboard features
 * in an app build with ngCordovaCustom.
 **/ 
 ngCordovaCustom.factory('$cordovaKeyboard', function() {
 	var isVisible=false;
...
/**
 * @ngdoc service
 * @name ngCordovaCustom.cordovaNetwork
 *
 * @description
 * A service for testing networked fetures
 * in an app build with ngCordovaCustom.
 */  
 ngCordovaCustom.factory('$cordovaNetwork', function () {
 	...
 	return {
		 ...
		 * @ngdoc property
		 * @name connectionType
		 * @propertyOf ngCordovaCustom.cordovaNetwork
		 *
		 * @description
...
/**
 * @ngdoc service
 * @name ngCordovaCustom.cordovaSocialSharing
 *
 * @description
 * A service for testing via social services
 * in an app build with ngCordovaCustom.
 */ 
 ngCordovaCustom.factory('$cordovaSocialSharing', ['$q', function($q) {
 	var throwsError = false;
 	var message = '';
 	var image = '';
 	var link = '';
 	...
 	return {
		 ...
		 * @ngdoc property
		 * @name throwsError
		 * @propertyOf ngCordovaCustom.cordovaSocialSharing
		 *
		 * @description
		 * A flag that signals whether a promise should be rejected or not. 
		 * This property should only be used in automated tests.
...
/**
 * @ngdoc service
 * @name ngCordovaCustom.cordovaSplashscreen
 *
 * @description
 * A service for testing the splash screen
 * in an app build with ngCordovaCustom.
 */ 
 ngCordovaCustom.factory('$cordovaSplashscreen', function() {
 	var isVisible = false;
 	...
 	return {
		 ...
		 * @ngdoc property
		 * @name isVisible
		 * @propertyOf ngCordovaCustom.cordovaSplashscreen
		 *
		 * @description
...
/**
 * @ngdoc service
 * @name ngCordovaCustom.cordovaStatusbar
 *
 * @description
 * A service for testing the status bar
 * in an app build with ngCordovaCustom.
 */ 
 ngCordovaCustom.factory('$cordovaStatusbar', function() {
 	...
 	return {
		 ...
		 * @propertyOf ngCordovaCustom.cordovaStatusbar
		 *
		 * @description
...
/**
 * @ngdoc service
 * @name ngCordovaCustom.cordovaVibration
 *
 * @description
 * A service for testing vibration
 * in an app build with ngCordovaCustom.
 */ 
 ngCordovaCustom.factory('$cordovaVibration', ['$timeout', function($timeout) {
 	...
 	return {
		 ...
		 * @ngdoc property
		 * @name vibrateTimer
		 * @propertyOf ngCordovaCustom.cordovaVibration
		 *
		 * @description
...
ngCordovaCustom.factory('$cordovaBackgroundGeolocation',  ['$q', '$window', function ($q, $window) {
...
ngCordovaCustom.factory('$cordovaSqlDbCopy',  ['$q', '$window', function ($q, $window) {
...
ngCordovaCustom.factory('$cordovaSQLite', ['$q', '$window', function ($q, $window) {

	return {
		openDB: function (dbName, background) {

			return $window.openDatabase(dbName, "1.0", "testing", 5*1024*1024);
		},
